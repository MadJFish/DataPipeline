...
# gsutil cp 1-wip-data/resale_lat_long.csv gs://ebd-group-project-data-bucket/2-nearby-resale/2-cleaned-data/
# gsutil cp 1-wip-data/resales_join_address.csv gs://ebd-group-project-data-bucket/2-nearby-resale/2-cleaned-data/
